# gin-csrf [![Test](https://github.com/stuartaccent/gin-csrf/actions/workflows/test.yml/badge.svg)](https://github.com/stuartaccent/gin-csrf/actions/workflows/test.yml)
